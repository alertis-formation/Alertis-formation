...
export const articles: Record<string, Article> = {
  ...
  "formation-afgsu-obligatoire-niveaux-1-2": {
    ...
    content: [
      ...
      { type: "p", text: "La formation AFGSU ne peut pas être dispensée par n'importe quel organisme. Elle relève des CESU, qui habilitent les centres et les formateurs autorisés à l'enseigner. Les formateurs AFGSU sont des professionnels de santé urgentistes, habilités par un CESU à enseigner l'AFGSU." },
